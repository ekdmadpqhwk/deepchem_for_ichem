...
INT_SYMBOLS = ['CA', 'CZ', 'O', 'OG', 'N', 'OD1', 'NZ', 'ZN']
ATM_TYPES = ['L', 'P', 'C']
...
class IPAMapFeaturizer1(MolecularFeaturizer):
    ...
    '''
    def __init__(self, edge_cutoff=4, use_atom_symbols=False):
    ...
    def _atom_featurizer(self, atom: RDKitAtom, mol: RDKitMol, idx) -> np.ndarray:
        ...
        int_symbol = get_tripos_atom_type_one_hot(mol, idx, INT_SYMBOLS, False)
        
        atom_type = is_ligand_one_hot(atom, ATM_TYPES, False)
